...
For MVP-0, new etxe projects must themselves be within 1 km of an existing etxe so construction can be physically reached. This makes expansion a sequence of inhabited/workable nodes.
