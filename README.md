...
- previewing construction suitability through a transparent green/red geography layer whose deterministic terrain, elevation, slope, drainage, historically sourced mining districts, and work-radius checks are independent of the visual basemap;
